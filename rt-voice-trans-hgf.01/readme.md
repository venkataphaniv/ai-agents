...
Link: <https://www.bomberbot.com/python/building-a-real-time-voice-translator-with-python-from-concept-to-code/>
...
1. Install the required Python libraries, including Playsound, using pip:

        pip install SpeechRecognition SpeechRecognition[audio] SpeechRecognition[google-cloud] googletrans pyttsx3 playsound3 gtts langdetect pvporcupine

2. Obtain Google Translate API credentials by following the instructions in the [Google Cloud Translation API documentation]<https://cloud.google.com/translate/docs/setup>.

3. Rename the `.env.example` file to `.env` and update it with your Google Translate API credentials.
